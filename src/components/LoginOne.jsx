    ...
    <Fragment>
      <section>
        <Container fluid={true}>
          <Row>
            <Col xl='7' className='b-center bg-size' style={{ backgroundImage: `url(${require('../assets/images/2.jpg')})`, backgroundSize: 'cover', backgroundPosition: 'center', display: 'block' }}>
